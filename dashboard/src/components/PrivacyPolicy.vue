<template>
  <div class="privacy-policy">
    <div class="wrapper">
      ...
      <p>
        Otter is a moderation bot for Discord that allows server staff to
      ...
      <p>
        ...
        <a href="https://github.com/OtterDevelopment/Otter">
          https://github.com/OtterDevelopment/Otter
        </a>
      </p>

      <h2>Stored data</h2>
      <p>
        When Otter is used by a server, the following categories data can be
        stored by the bot.
        The specific categories of data saved for each server depends on how the
        server has configured Otter.
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>Infraction record data is kept until the server stops using Otter
        ...
        <li>User information for users logged in to the bot's web dashboard via
          Discord OAuth is stored as long as the server uses Otter
        </li>
      </ul>
