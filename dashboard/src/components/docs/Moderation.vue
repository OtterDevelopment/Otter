<template>
  <div>
    <header>
      <h1>Moderation</h1>
      <p>
        Moderation in Otter is multi-layered. On top of typical actions such
        as warning, muting, kicking, and banning, Otter allows moderators to
    ...
    <p>
      So that your moderators may use Otter moderation, you must define the
    ...
    <p>These config options define how Otter will interact with the
    ...
    <p>
      When a member is banned, Otter automatically deletes the last day of
